...
public class BankUtil {
	...
	// 传入卡号 得到银行名称（全称）
	public static String getFullNameOfBank(String idCard) {
	 ...
	 * @return
	 */
	public static String getPrefixNameOfBank(String idCard){
		String fullName = getFullNameOfBank(idCard);
	...
	private final static String[] bankBin = { "621098", "622150", "622151", "622181", "622188", "955100", "621095",
			...
			"628267", "621392", "621481", "621310", "621396", "623251", "628351", "622991", "621585", "623013", "623059" };
	...
	private static final String[] bankName = { "邮储银行·绿卡通", "邮储银行·绿卡银联标准卡", "邮储银行·绿卡银联标准卡", "邮储银行·绿卡专用卡", "邮储银行·绿卡银联标准卡",
			...
			"东营莱商村镇银行·绿洲卡", "建设银行·单位结算卡", "玉溪市商业银行·红塔卡", "河南省农村信用社·借记卡", "河南省农村信用社·借记卡", "河南省农村信用社·借记卡", "河南省农村信用社·借记卡" };
	
	
	@SuppressWarnings("unused")
	public static void main(String[] args) {

		String cardNum2 = "623059151000048322";//"验证 河南省农村信用社·借记卡"
		String cardNum1 = "6217582000004689238";//"验证 中国银行·医保联名借记IC卡"
		String cardNum3 = "6210817200020188106";//"验证 建设银行·金融IC卡"
		String cardNum4 = "6214857551819693";//"验证 招商银行·银联IC金卡"
		String cardNum5 = "6217562000007020773";//"验证 中国银行·社保联名借记IC卡"
		System.out.println("bankBin:"+bankBin.length);
		System.out.println("bankName:"+bankName.length);
		
		System.out.println("验证正确性："+checkBankCard(cardNum1)
		+"|所属银行："+getFullNameOfBank(cardNum1)
		+"|所属银行(简)："+getPrefixNameOfBank(cardNum1));
