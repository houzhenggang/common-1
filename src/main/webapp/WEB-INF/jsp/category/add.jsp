...
<jsp:include page="/base/user/head" flush="true"/>
        ...
        <div class="management-center second-section">
            <div class="second-title">
                <a href="${ctx}/base/user/home">管理中心</a> <a href="${ctx}/manage/category/list"> > 商品类别</a> <span> > 新增类别</span>
            </div>
            <form action="${ctx}/manage/category/add" method="post">
	            <div class="new-recruit">
	                <div class="bug-input input310">
	                <p>类别名称:</p><input type="text" name="name" value="${categoryCommand.name}" />
	                </div>
