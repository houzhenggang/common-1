...
<jsp:include page="/base/user/head" flush="true"/>
        ...
        <div class="management-center second-section">
            <div class="second-title">
                <a href="${ctx}/base/user/home">管理中心</a> <a href="${ctx}/manage/style/list"> > 风格类型</a> <span> > 新增风格</span>
            </div>
            <form action="${ctx}/manage/style/add" method="post">
	            <div class="new-recruit">
	                <div class="bug-input input310">
	                <p>风格类型:</p><input type="text" name="name" value="${styleCommand.name}" />
	                </div>
