...
<jsp:include page="/base/user/head" flush="true"/>
        ...
        <div class="management-center second-section" >
            <div class="second-title">
                <a href="${ctx}/base/role/list">角色管理</a> <span> > 新增角色</span>
            </div>
            
            <form action="${ctx}/base/role/add" method="post">
...
<link rel="stylesheet" type="text/css" href="${ctx}/oTree/css/otree/otree.css">
