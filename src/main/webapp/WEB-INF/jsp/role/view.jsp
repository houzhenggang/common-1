...
<jsp:include page="/base/user/head" flush="true"/>
        ...
        <div class="management-center second-section" >
            <div class="second-title">
                <a href="${ctx}/base/role/list">角色管理</a> <span> > 查看角色</span>
            </div>
            
	            <div class="new-manager" >
	                <div>
	                    <div class="bug-input ml30 input310">
	                    <p>角色名称:</p><input type="text" name="name" value="${roleCommand.name}" readonly="readonly"></div>
	                    <div class="bug-input ml30 input310">
	                    <p>角色描述:</p><input type="text" name="description" value="${roleCommand.description}" readonly="readonly"></div>
	                </div>
